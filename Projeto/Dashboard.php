...
<?php if (!empty($serv)){ ?>
    ...
    <a href="/ProjetoEscala/Escala-Medica/Projeto/Cadastro.php" ><button>Cadastrar</button></a>
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($serv as $a) { ?>
                <tr>
                    <td><?php echo $a['nome_serv']?></td>
                    <td><?php echo $a['cpf']?></td>
                    <td><?php echo $a['email']?></td>
                    <td><?php echo $a['matricula']?></td>
                    <td><?php echo $a['id_esp']?></td>
                    <td><?php echo $a['statu']?></td>
                    <td>
                        <a href="editar.php?id=<?php echo $a['id_serv']; ?>">Editar</a>
                        <a href= >Excluir</a>
                    </td>
                </tr>
            <?php }?>
